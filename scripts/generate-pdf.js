...
(async () => {
  ...
  if (!fs.existsSync(cvHtmlPath)) {
    console.error(
      `Cannot find ${cvHtmlPath}. Run "jekyll build" before this script.`
    );
    process.exit(1);
  }
  ...
  try {
    ...
    console.log(`PDF font-family: ${fontFamily}`);
    ...
    console.log(`PDF generated: ${datedOutputPath}`);
    console.log(`Copied as: ${stableOutputPath}`);
